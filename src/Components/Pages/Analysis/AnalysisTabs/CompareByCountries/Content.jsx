...
import './CompareByCountries.scss';


import Pic from '../../../../../Assets/Analysis/tab2/pic.svg';
import Clock from '../../../../../Assets/Analysis/tab5/clock.svg';
import Share from '../../../../../Assets/Analysis/tab5/share.svg';
import Internet from '../../../../../Assets/Analysis/tab5/internet.svg';



const CompareByCountriesContent = () => {
    return (
...
export default CompareByCountriesContent;